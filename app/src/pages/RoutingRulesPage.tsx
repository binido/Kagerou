  ...
  return (
    <div className="min-h-screen min-w-0 bg-canvas px-6 py-8 lg:px-12 lg:py-10">
      <div className="mx-auto w-full max-w-[1000px]">
        ...
        <section aria-labelledby="rules-heading" className="mt-10"><div className="mb-3 flex items-end justify-between gap-6"><div><p className="type-eyebrow mb-1">{t('page.customRules')}</p><h2 className="text-[16px] font-semibold tracking-[-0.015em] text-[#e8e5ee]" id="rules-heading">{t('page.trafficMatches')}</h2></div><p className="text-[11px] text-quiet">{t('page.firstMatchWins')} <span className="px-1 text-quiet">·</span> {t('page.rulesCount', { count: rules.length })}</p></div><RoutingRulesTable onEdit={setEditingRule} onSelect={selectRule} rules={rules} /></section>
