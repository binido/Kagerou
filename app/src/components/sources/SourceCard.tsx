...
export function SourceCard({ source, refreshing, onRefresh, onEdit, onRemove }: SourceCardProps) {
  ...
  return (
    <Card className={cn('rounded-[10px] border border-hairline bg-surface p-5 shadow-none transition-colors duration-150 hover:border-[#3a3942] hover:bg-row-hover', refreshing && 'border-warn/40')}>
