    ...
    <Dialog onOpenChange={onOpenChange} open={open}>
      <DialogContent className="border-hairline bg-raised text-primary sm:max-w-[440px]">
        <DialogHeader>
          ...
          <DialogTitle className="type-display mt-2 text-2xl text-primary">
            {isRename ? t('dialogs.group.renameTitle') : t('dialogs.group.newTitle')}
          </DialogTitle>
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          <Field>
            <FieldLabel className="text-[12px] text-primary" htmlFor="profile-group-name">
          ...
          <DialogFooter>
            ...
            >
              ...
              {isRename ? t('dialogs.group.save') : t('dialogs.group.create')}
            </Button>
          </DialogFooter>
        </form>
      </DialogContent>
